    ...
    <div class="row">
        ...
        <div class="col-md-12">
                ...
                <div class="col-md-3 mt-4">
                    ...
                    <input type="textarea" class="form-control" value="{{@$activo->observacion}}" disabled>
                </div>
                <div class="col-md-3 mt-4">
                    <label for="fecha_fin">Fecha Entrega</label>
                    <input type="datetime" class="form-control" name="fecha_fin" value="{{ $activo->fecha_fin }}" disabled>
                </div>

                <div class="col-md-3 mt-4">
                    <input type="hidden" class="form-control" name="estado_id" value="{{ $activo->estado }}">
                </div>
                <div class="mt-3">
                    <a href="{{route('asignacion.index')}}" class="btn btn-outline-dark">Cancelar</a>
                    <a href="{{ route('asignacion.edit', $activo->id) }}" class="btn btn-outline-primary">Editar</a>
                </div>
            </form>
        </div>
    </div>
